...
################################################################################
# =============================================================================
# # 定义：Ren'Py 默认 UI 的公共样式配置（字体大小、按钮边距、对话框文本框底图、默认颜色值）。
# # 实现：为全游戏所有通用界面（如存档、设置、主菜单、标准对话框）提供统一的视觉主题。
# =============================================================================
...
## 游戏内文本使用的字体。
define gui.text_font = "fusion-pixel-12px-proportional-zh_hans.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "fusion-pixel-12px-proportional-zh_hans.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fusion-pixel-12px-proportional-zh_hans.ttf"
...
#define gui.game_menu_background = "images/bg_game_menu.png"
