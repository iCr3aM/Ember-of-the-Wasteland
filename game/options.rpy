...
## 在适用的时候您可能需要对其取消注释。
# =============================================================================
# # 定义：游戏基础元数据（窗口分辨率、游戏标题、版本号、日志保存路径、声音通道等）。
# # 实现：管理游戏打包时的规则，控制 Ren'Py 的底层基础窗体行为。
# =============================================================================
## 基础 ##########################################################################
...
define config.name = _("Ember of the Wasteland")
...
define config.version = "0.5PreView"
...
{color=#FFD700}支持者：MacHowskl、EDDIE、LeC、ganla1、Weijii、KingYoung{/color}
""")
...
define build.name = "EmberoftheWasteland"
